// select elements of the dom and store in a variable
...
// function to get video from webcam
const getVideo = () => {
...
// function to display video on canvas
const paintToCanvas = () => {
...
// function to capture photo and create a link giving option to download image
function takePhoto(){
    snap.currentTime = 0;
    snap.play();
